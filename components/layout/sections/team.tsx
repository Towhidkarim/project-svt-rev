  ...
  const teamList: TeamProps[] = [
    {
      ...
      firstName: ' Alex',
      lastName: 'Carter',
      positions: ['Faculty of Business Administration'],
      socialNetworks: [
        {
          name: 'LinkedIn',
    ...
    },
    {
      ...
      firstName: 'Jordan',
      lastName: 'Moore',
      positions: ['Department of Psychology'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/leopoldo-miranda/',
    ...
    },
    {
      ...
      firstName: 'David',
      lastName: 'Diaz',
      positions: ['Faculty of Environmental Science'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/leopoldo-miranda/',
    ...
    },
    {
      ...
      firstName: 'Sarah',
      lastName: 'Robinson',
      positions: ['School of Engineering'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/leopoldo-miranda/',
    ...
    },
    {
      ...
      firstName: 'Michael',
      lastName: 'Holland',
      positions: ['Department of Sociology'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/leopoldo-miranda/',
    ...
    },
    {
      ...
      firstName: 'Evan',
      lastName: 'James',
      positions: ['Department of Medicine'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/leopoldo-miranda/',
    ...
    },
    {
      ...
      firstName: 'Pam',
      lastName: 'Taylor',
      positions: ['Department of Computer Science'],
      socialNetworks: [
        {
          name: 'X',
